...
public class StringTests {
    ...
    public void stringLengthSort_methodCall() {
        strings.stream()
                .sorted((s1, s2) -> compareStrings(s2, s1))
                .forEach(System.out::println);
    }
    ...
    public void stringLengthSort_methodRef() {
        strings.stream()
                .sorted(StringTests::compareStrings)
                .forEach(System.out::println);
    }
    ...
    public void demoCollectors() {
        ...
        List<String> stringsWithNulls = Arrays.asList("this", "is", null,
                "a", null, null, "list", "of", null, "strings");
        ...
        Logger logger = Logger.getLogger("StringTests");
        Consumer<String> consolePrinter = System.out::println;
        Consumer<String> loggerPrinter = logger::info;

        stringsWithNulls.stream()
                .filter(nonNull.and(evenLength))
                .forEach(consolePrinter.andThen(loggerPrinter));
    }
