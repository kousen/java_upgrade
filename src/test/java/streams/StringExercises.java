...
public class StringExercises {
    ...
    public void demoCollectors() {
        ...
        List<String> stringsWithNulls = Arrays.asList(null, "this", null,
                "is", "a", null, "list");
        ...
        Predicate<String> evenLength = (String s) -> s.length() % 2 == 0;
        Predicate<String> nonNull = Objects::nonNull;
        result = stringsWithNulls.stream()
        ...
        // Deeply evil, but works
        //result.forEach(((Consumer<String>) logger::info).andThen(System.out::println));
        result.forEach(log.andThen(out));
    }
