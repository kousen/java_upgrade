...
public class StringExercises {
    ...
    public void demoCollectors() {
        ...
        Predicate<String> nonNullAndEven = nonNull.and(evens);
        printFilteredStrings(myStrings, nonNullAndEven);
    }

    public static void printFilteredStrings(List<String> strings, Predicate<String> predicate) {
        strings.stream()
                .filter(predicate)
                .forEach(System.out::println);
    }
